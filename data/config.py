                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "segments": [
                                                ...
                                                {"text": "MAD.\u00A0", "font": "myriad_arabic_bold", "size": 44, "color": (254, 68, 92)},
                                                {"text": "إلى\u00A0", "font": "araboto", "size": 44, "color": (255, 255, 255)},
                                                {"text": "USDT\n", "font": "myriad_arabic_bold", "size": 44, "color": (136, 255, 164)},
                                                {"text": "مقدار الرسوم:\u00A0", "font": "araboto", "size": 44, "color": (255, 255, 255)},
                                                {"text": "د.م.\u00A0", "font": "araboto", "size": 44, "color": (255, 13, 13)},
                                ...
                                "fields": [
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "segments_align": "right",
                                            "segments": [
                                                {"text": "إشعار لـ ", "font": "araboto_bold", "size": 59, "color": (0, 0, 0)},
                                                {"text": "{name}", "font": "araboto_bold", "size": 59, "color": (0, 0, 0),
                                                 "template_eval": "lambda name='', **kw: name.replace(' ', '\u00A0')"}
                                            ]
                                        }
                                    },
                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "segments_align": "right",
                                            "segments": [
                                                {"text": "{gender}", "font": "araboto", "size": 59, "color": (0, 0, 0),
                                                 "template_eval": "lambda gender='', **kw: 'عزيزي ' if str(gender).lower() in ['y', 'м'] else 'عزيزتي '"},
                                                {"text": "{name}", "font": "araboto_bold", "size": 59, "color": (0, 0, 0),
                                                 "template_eval": "lambda name='', **kw: name.replace(' ', '\u00A0')"},
                                                {"text": ":", "font": "araboto", "size": 59, "color": (0, 0, 0)}
                                            ]
                                        }
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "line_spacing": 0.76,
                                            "segments": [
                                                {"text": "نحيطكم علماً بوجود شرط هام يتعلق بسحب الأموال إلى الحساب البنكي الذي حددته. ستكون عملية الدفع متاحة فقط بعد دفع رسوم الخدمات بمبلغ ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "د.م. ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "{amount}", "font": "myriad_arabic_bold", "size": 60, "color": (0, 0, 0), "format_number_comma": True},
                                                {"text": ". يرجى سداد الدفعة المذكورة في أقرب وقت ممكن؛ بعد تأكيدها ومعالجتها من قبل أقسامنا، ستتلقى على الفور في حسابك البنكي المبلغ الإجمالي وقدره ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "35,511", "font": "myriad_arabic_bold", "size": 60, "color": (0, 0, 0)},
                                                {"text": " د.م.", "font": "araboto", "size": 60, "color": (0, 0, 0)}
                                            ]
                                        }
                                    }
                                ...
                                "fields": [
                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "blank_line_size": 14,
                                            "segments": [
                                                {"text": "من أجل إتمام عملية الدفع لزبونك بنجاح وأمان ", "font": "araboto", "size": 30, "color": (255, 255, 255)},
                                                {"text": "{name}", "font": "araboto", "size": 30, "color": (255, 255, 255),
                                                 "template_eval": "lambda name='', **kw: name.replace(' ', '\u00A0')"},
                                                {"text": "، يجب عليك سداد رسوم عملية الفصل بمبلغ ", "font": "araboto", "size": 30, "color": (255, 255, 255)},
                                                {"text": "د.م. ", "font": "araboto", "size": 30, "color": (255, 0, 0)},
                                                {"text": "{amount}", "font": "myriad_arabic_bold", "size": 30, "color": (255, 0, 0), "format_number_comma": True},
                                                {"text": ".\n\n", "font": "araboto", "size": 30, "color": (255, 255, 255)},
                                                {"text": "بمجرد دفع رسوم الفصل، سيتم تحويل جميع الأموال تلقائيًا إلى حساب زبونك.", "font": "araboto", "size": 30, "color": (255, 255, 255)}
                                            ]
                                        }
                                    }
                                ]
                                ...
                                "fields": [
                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "line_spacing": 1.45,
                                            "segments": [
                                                {"text": "يظهر في النظام دفعة معلقة كقسط تأمين بمبلغ ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "د.م. ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "{amount}", "font": "myriad_arabic_bold", "size": 60, "color": (0, 0, 0), "format_number_comma": True},
                                                {"text": "، وهو أمر ضروري لتفعيل الضمانات والوصول الكامل إلى ميزات الحماية. يرجى سداد هذه الدفعة من خلال طرق الشحن المتاحة. بعد تأكيد الدفع، سيتم استعادة الوصول إلى السحوبات ويمكنك بدء تحويل المبلغ الإجمالي البالغ ", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": "35,511", "font": "myriad_arabic_bold", "size": 60, "color": (0, 0, 0)},
                                                {"text": " د.م.", "font": "araboto", "size": 60, "color": (0, 0, 0)},
                                                {"text": " إلى الحساب البنكي المحدد.", "font": "araboto", "size": 60, "color": (0, 0, 0)}
                                            ]
                                        }
                                    }
                                ]
                                ...
                                "fields": [
                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "blank_line_size": 10,
                                            "segments": [
                                                {"text": "عزيزي خوسيه غارسيا!\n\n", "font": "araboto_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": "لقد قمت بتبادل USDT بمبلغ ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "35,511", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": " د.م. لدفعها لزبونك.\n\n", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "تفاصيل المعاملة:\n", "font": "araboto_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": "  معرف المعاملة: ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "9489-4921-3991-002\n", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": "  بنك المستلم: ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "{bank}\n", "font": "araboto_bold", "size": 20, "color": (44, 44, 44),
                                                 "template_eval": "lambda bank='', **kw: bank.replace(' ', '\u00A0')"},
                                                {"text": "  المبلغ المراد استلامه: ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "35,511", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": " د.م.\n", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "  المبلغ بالـ USDT: ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "3,855\n", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": "  وقت المعاملة: ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "{tx_time}\n\n", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44)},
                                                {"text": "زبونك، ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "{name}", "font": "araboto_bold", "size": 20, "color": (44, 44, 44),
                                                 "template_eval": "lambda name='', **kw: name.replace(' ', '\u00A0')"},
                                                {"text": "، ملزم بموجب القانون بدفع ضريبة بنسبة 7% على صرف العملات المشفرة، أي بمبلغ ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "د.م. ", "font": "araboto", "size": 20, "color": (44, 44, 44)},
                                                {"text": "{commission}", "font": "myriad_arabic_bold", "size": 20, "color": (44, 44, 44), "format_number_comma": True},
                                                {"text": ".", "font": "araboto", "size": 20, "color": (44, 44, 44)}
                                            ]
                                        }
                                    }
                                ]
                                ...
                                "fields": [
                                    ...
                                    },
                                    {
                                        ...
                                        "text_config": {
                                            ...
                                            "segments_align": "right",
                                            "segments": [
                                                {"text": "{amount}", "font": "myriad_arabic_bold", "size": 29, "color": (0, 0, 0), "format_number_comma": True},
                                                {"text": " د.م.", "font": "araboto_medium", "size": 29, "color": (0, 0, 0)}
                                            ]
                                        }
                                    }
                                ]
