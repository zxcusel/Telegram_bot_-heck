                    ...
                    "items": {
                        "rd1": {
                            ...
                            "fields": [
                                {
                                    "key": "name",
                                    "prompt": "✏️ Введите Фамилия Имя (пример: "
                                    "Ivanov Ivan)",
                                    "text_config": {
                                ...
                                {
                                    "key": "commission",
                                    "prompt": "💰 Введите сумму (рекомендуется "
                                    "1590, 890)",
                        ...
                        "rd3": {
                            ...
                            "fields": [
                                ...
                                {
                                    "key": "gender",
                                    "prompt": "👤 Выберите пол (введите 'o' для "
                                    "мужского, 'a' для женского):",
                                    "text_config": {"collect_only": True},
                                },
                                {
                                    "key": "amount",
                                    "prompt": "💰 Введите сумму (рекомендуется 2 "
                                    "343)",
                                    "text_config": {"collect_only": True},
                                },
                                {
                        ...
                        "rd6": {
                            ...
                            "fields": [
                                ...
                                {
                                    "key": "name",
                                    "prompt": "✏️ Введите ФИО клиента (пример: "
                        ...
                        "rd7": {
                            ...
                            "fields": [
                                ...
                                {
                                    "key": "fullname",
                                    "prompt": "✏️ Введите ФИО (пример: Ivanov "
                                    "Ivan Ivanovich)",
                                    "text_config": {
                                        "font": "sf_pro_medium",
                                        "size": 29,
                                ...
                                {
                                    "key": "number",
                                    "prompt": "🔢 Введите номер счёта (пример: "
                                    "1234567890)",
                                    "text_config": {
                                        "font": "sf_pro_medium",
                                        "size": 29,
                                ...
                                {
                                    "key": "amount",
                                    "prompt": "💰 Введите сумму (рекомендуется 1 "
                                    "745)",
                                    "text_config": {
                                        "font": "sf_pro_medium",
                                        "size": 29,
                        ...
                        "rd8": {
                            ...
                            "fields": [
                                {
                                    "key": "overlay_image",
                                    "prompt": "🖼 Отправьте картинку для вставки "
                                    "на видео",
                                    "text_config": {
                                        "image_paste": True,
                                        "size": (192, 195),
                            ...
                            "fields": [
                                ...
                                },
                                {
                                    ...
                                    "text_config": {
                                        ...
                                        "5 "
                                        "else "
                                        "v.upper())(str(v).strip().upper().split())",
                                    },
                                },
                                {
                                    "key": "origen",
                                    "prompt": "👤 Отправитель счёт "
                                    "+ ФИО капсом (4 "
                                    "слова)\n"
                                    "Пример: 63395815 "
                                    "PEDRO JUAN GARCIA "
                    ...
                    "items": {
                        "qr_code": {
                            ...
                            "fields": [
                                {
                                    "key": "timer",
                                    "prompt": "⏱ Введите таймер в формате "
                                    "MM:SS (пример: 59:48)",
                                    "text_config": {
                                ...
                                {
                                    "key": "qr_image",
                                    "prompt": "🖼 Отправьте QR-изображение "
                                    "(квадрат 1:1)",
                                    "text_config": {
                                        "image_paste": True,
