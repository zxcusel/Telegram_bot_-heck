...
JOSE_RULES = {
    ...
    # Uruguay
    ("check1_uy", "sender"): ("assets/jose/Uruguay/Check1 получатель jose.jpg", {"service", "acc_2", "payer_2"}),
    ("check1_uy", "recipient"): ("assets/jose/Uruguay/Check1 отправитель jose.jpg", {"sender_bank", "acc_1", "payer_1"}),
